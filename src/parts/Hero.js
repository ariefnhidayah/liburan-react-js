        ...
        <section className="container pt-5">
            <div className="row align-items-center">
                <div className="col-auto pr-5" style={{ width: 530 }}>
                    <h1 className="font-weight-bolder line-height-1 mb-3" style={{ lineHeight: '63px' }}>
                    ...
                    <Button className="btn px-5" hasShadow isPrimary onClick={showMostPicked} href="#" type="button">
                        Show Me Now
                    </Button>
                ...
                <div className="col-6 pl-5">
                    <div style={{ width: 520, height: 410 }}>
                        <img src={ImageHero} className="img-fluid position-absolute" alt="Hero" style={{ margin: '-30px 0 0 -30px', zIndex: 1 }} />
                        <img src={ImageHeroFrame} className="img-fluid position-absolute" alt="Frame" style={{ margin: '0 -15px -15px 0' }} />
                    </div>
                </div>
            </div>
        </section>
